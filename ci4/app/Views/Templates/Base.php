...
<html lang="en">
	<head>
		...
		<link href="tweeter.css" rel="stylesheet">
		<script src="create_twit.js"></script>
	...
	<body id="page-top">
		<nav class="navbar navbar-expand navbar-dark bg-primary static-top">
			<a class="navbar-brand mr-1" href="<?= site_url() ?>">Tweeter</a>
			<ul class="navbar-nav ml-4">
				<li class="nav-item">
					<a style="color: white" href="<?= site_url('account/home') ?>">Your Feed</a>
				</li>
			</ul>
